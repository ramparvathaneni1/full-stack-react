...
1. Open Postman
2. The collection should already be available in Postman. If it's not, you can locate the
   `todo_app.postman_collection.json` file in the `express-to-do-api` folder and import it into Postman.
